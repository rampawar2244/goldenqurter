...
<!--  <a href="rock.php">On The Rocks</a>-->
  
  
  
<!--  <a href="rock.php">Hot Brew</a>-->
<!--  <a href="rock.php">Cold Brew</a>-->
  ...
  <span class="checkmark"></span>
    ...
    <div class="main-card">
        <div class="flip-card">
           ...
           <img class="flip" src="mainimages/Morning Quarters/Rose Delight+ Quarter.jpg" alt="Avatar">
                    <!-- <h4>demo</h4> -->
                </div>
                <div class="flip-card-back">
                    <h3>Rose Delight+ Quarter</h3>
                    <p>Eggs</p>
                    <p>Rose Delight+ Quarter</p>
                    <h4>Prise:-135</h4>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img class="flip" src="mainimages/Morning Quarters/Rose Delight+ Waffles.jpg" alt="Avatar">
                </div>
                <div class="flip-card-back">
                <h3>Rose Delight+ Waffles</h3>
                    <p>Eggs</p>
                    <p>Rose Delight+ Waffles</p>
                    <h4>Prise:-160</h4>
                    <button class="button"><a href="https://wa.me/918806258784">Order Now </a></button>
                </div>
            </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img class="flip" src="mainimages/Morning Quarters/Scrambbled Eggs+ Quarters.jpg" alt="Avatar">
                </div>
                <div class="flip-card-back">
                <h3>Scrambbled Eggs+ Quarters</h3>
                    <p>Eggs</p>
                    <p>Scrambbled Eggs+ Quarters</p>
                    <h4>Prise:-105</h4>
                    <button class="button"><a href="https://wa.me/918806258784">Order Now </a></button>
                </div>
            </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img class="flip" src="mainimages/Morning Quarters/Sunny Side up + Quarter.jpg" alt="Avatar">
                </div>
                <div class="flip-card-back">
                <h3>Sunny Side up + Quarter</h3>
                    <p>Eggs</p>
                    <p>Sunny Side up + Quarter</p>
                    <h4>Prise:-105</h4>
                    <button class="button"><a href="https://wa.me/918806258784">Order Now </a></button>
                </div>
            </div>
