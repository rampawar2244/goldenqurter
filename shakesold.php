    ...
    <div class="main-card">
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <img class="flip" src="mainimages/Beverages/Chocolate Shake.jpg" alt="Avatar">
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                <img class="flip" src="mainimages/Beverages/Mango Shake.jpg" alt="Avatar">
                </div>
                <div class="flip-card-back">
                <h3>Mango Shake</h3>
                    <p></p>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                <img class="flip" src="mainimages/Beverages/Strawberry Shake.jpg" alt="Avatar">
                </div>
                <div class="flip-card-back">
        ...
        <!-- <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                <img class="flip" src="mainimages/Beverages/Americano.jpg" alt="Avatar">
                </div>
                <div class="flip-card-back">
                    <h1>Demo</h1>
                    <p>This is demo</p>
