...
<!--  <a href="#active">Cream Blended Frappes</a>-->
    ...
    <div class="main-card">
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <img class="flip" src="mainimages/cream.jpg" alt="Avatar">
                    
                </div>
                <div class="flip-card-back">
                <h3>Cream blended frappes</h3>
                    <p></p>
                    <p>Cream blended frappes</p>
                    <h4>Prise:-160</h4>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                <img class="flip" src="mainimages/cream2.jpg" alt="Avatar">                </div>
                <div class="flip-card-back">
                <h3>vanilla creme frappe</h3>
                    <p></p>
                    <p></p>
                    <h4>Prise:-160</h4>
                    <button class="button"><a href="https://wa.me/918806258784">Order Now </a></button>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                <img class="flip" src="mainimages/cream3.jpg" alt="Avatar">                </div>
                <div class="flip-card-back">
                <h3>hazelnut creme frappe</h3>
                    <p></p>
                    <p></p>
                    <h4>Prise:-255</h4>
        ...
        <!-- <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                <img class="flip" src="mainimages/Beverages/Mango Shake.jpg" alt="Avatar">                </div>
                <div class="flip-card-back">
