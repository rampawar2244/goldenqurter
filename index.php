...
<body>
    ...
    <div class="main-card">
        <div>
            <a href="product.php"> <img class="flip" src="mainimages/All Day Quarters/Waffle+ Veg Q.jpg" alt="Avatar">
            </a>
            <h4 style="text-align: center;">Morning Quarter</h4>
        </div>
        <div>
            <a href="product.php"><img class="flip" src="mainimages/Sides & Snacks + Empanadas/Spinach Mozarella Empanada.jpg" alt="Avatar"></a>
            <h4 style="text-align: center;">Empandas</h4>
        </div>

        <div>
            <a href="product.php"><img class="flip" src="mainimages/Sides & Snacks + Empanadas/French Fries (2).jpg" alt="Avatar"></a>

            <h4 style="text-align: center;">Side & Snacks</h4>
        </div>
    </div>

    <div class="main-card">
        <div>
            <a href="product.php"> <img class="flip" src="mainimages/Coffee Combos/IMG_5030 copy.jpg" alt="Avatar"></a>
            <h4 style="text-align: center;">Patteseries</h4>
        </div>


        <div>
            <a href="product.php"><img class="flip" src="mainimages/Beverages/Latte (5).jpg" alt="Avatar"></a>

            <h4 style="text-align: center;">Beverages</h4>
        </div>
