    ...
    <div class="main-card">
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <img class="flip" src="mainimages/Pattiseries/3 Macarons.jpg" alt="Avatar">
                </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img class="flip" src="mainimages/Pattiseries/Red Velvet Cupcake+ Vanilla Cupcake + Chocolate Cupcake.jpg" alt="Avatar">
                </div>
                <div class="flip-card-back">
                <h3> Cupcake</h3>
                    <p></p>
                    <p>Red Velvet Cupcake+Vanilla Cupcake+Chocolate Cupcake</p>
                    <h4>Prise:-45</h4>
                    <button class="button"><a href="https://wa.me/918806258784">Order Now </a></button>
                </div>
            </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                <img class="flip" src="mainimages/Pattiseries/Blueberry MacaronsDramatic Photo 2.jpg" alt="Avatar">
                </div>
                <div class="flip-card-back">
                <h3>Blueberry MacaronsDramat</h3>
                    <p></p>
                    <p>Blueberry MacaronsDramat</p>
                    <h4>Prise:-250</h4>
                    <button class="button"><a href="https://wa.me/918806258784">Order Now </a></button>
                </div>
            </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                <img class="flip" src="mainimages/Pattiseries/Cinnamon Rolls Dramatic Photo.jpg" alt="Avatar">
                </div>
                <div class="flip-card-back">
                <h3>Cinnamon Rolls Dramatic</h3>
                    <p></p>
                    <p>Cinnamon Rolls Dramatic</p>
                    <h4>Prise:-65</h4>
                    <button class="button"><a href="https://wa.me/918806258784">Order Now </a></button>
                </div>
            </div>
